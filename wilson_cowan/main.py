...
from wc_utils import plot_figure_4b, plot_figure_4c, plot_training_loss
...
def main():
    ...
    print(
        f"Starting training for up to {NUM_EPOCHS} epochs (with patience of {EARLY_STOPPING_PATIENCE})..."
    )
